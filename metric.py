...
def captioning_metrics(all_logs, data_path):
    ...
    with suppress_output():
        soda_metrics = eval_soda(pred_result, [gt_js])
    with suppress_output():
        dvc_metrics = eval_dvc(pred_result, [gt_js], 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default='raw_videos_test/video_test_1171/longvale-annotations-eval.json')
